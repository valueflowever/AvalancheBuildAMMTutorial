  ...
  describe('updateVersion', () => {
    describe('never initialized', () => {
      ...
      it('clears the current lists', () => {
        expect(
          store.getState().byUrl['https://unpkg.com/quickswap-default-token-list@1.0.64/build/quickswap-default.tokenlist.json']
        ).toBeUndefined()
        expect(store.getState().byUrl['https://unpkg.com/quickswap-default-token-list@1.0.64']).toBeUndefined()
      })
