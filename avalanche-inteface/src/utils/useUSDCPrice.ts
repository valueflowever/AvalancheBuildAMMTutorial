import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from 'avalanche-swap-test'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.tAVAX ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.tAVAX ? USDC : undefined]
    ],
